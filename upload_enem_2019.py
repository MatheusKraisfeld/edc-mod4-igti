...
spark = (
    ...
    .config(
        "spark.jars.packages",
        "org.apache.hadoop:hadoop-aws:3.1.2,io.delta:delta-core_2.12:1.0.0",
    )
...
df = (
    ...
    .option("delimiter", ";")
    .option("header", "true")
    .csv("/mnt/e/Estudos/ENEM_2019/DADOS/MICRODADOS_ENEM_2019.csv")
)
df.printSchema()
...
df.write.mode("overwrite").parquet("s3a://landing-zone-741358071637/enem/2019")
